-- =====================================================
-- Fix Staff Commission: CHỈ loại trừ NVKD, GIỮ NGUYÊN logic tính toán gốc
-- =====================================================
-- Thay đổi DUY NHẤT: Loại trừ role = 'NhanVienKinhDoanh'
-- =====================================================
...
-- 2. Drop and recreate with original logic + NVKD exclusion
...
BEGIN
    ...
    WITH participated_tasks AS (
        ...
        AND p.role != 'NhanVienKinhDoanh'  -- CHỈ THÊM DÒNG NÀY: Loại trừ NVKD
    ),
